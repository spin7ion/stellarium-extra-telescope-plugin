...
class NexStarCommandSetTime : public NexStarCommand
{
public:
	NexStarCommandSetTime(Server &server, unsigned int Q_int, unsigned int R_int, unsigned int S_int, unsigned int T_int, unsigned int U_int, unsigned int V_int, unsigned int W_int, unsigned int X_int);
