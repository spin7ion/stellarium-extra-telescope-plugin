...
void NexStarConnection::sendTime(unsigned int Q, unsigned int R, unsigned int S, unsigned int T, unsigned int U, unsigned int V, unsigned int W, unsigned int X)
{
	sendCommand(new NexStarCommandSetTime(server, Q, R, S, T, U, V, W, X));
}
